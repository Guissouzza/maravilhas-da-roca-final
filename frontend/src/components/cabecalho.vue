...
>
  <div class="max-w-7xl mx-auto flex items-center justify-between gap-4">
    ...
    <nav class="hidden sm:flex items-center gap-6 text-sm font-bold tracking-wide text-[#7A5C43]">
      <RouterLink to="/" class="hover:text-[#A0522D] transition-colors">Início</RouterLink>
      <RouterLink to="/catalogo" class="hover:text-[#A0522D] transition-colors">Catálogo</RouterLink>
      <RouterLink to="/favoritos" class="hover:text-[#A0522D] transition-colors">Favoritos</RouterLink>
      <RouterLink to="/sobre" class="hover:text-[#A0522D] transition-colors">Sobre nós</RouterLink>
    </nav>
