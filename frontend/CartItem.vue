...
<template>
  ...
  <div class="bg-white p-6 rounded-2xl border border-gray-100 flex gap-6 relative shadow-sm">
...
>
  <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" />
      ...
      <h3 class="text-2xl font-bold text-[#3E2723] leading-tight pr-8">{{ props.item?.nome || 'Carregando...' }}</h3>
      <p class="text-base text-gray-400 mt-2">{{ props.item?.legenda || 'Por favor, aguarde' }}</p>
    ...
    <div class="absolute bottom-6 right-6 bg-[#C5A880] text-white font-semibold flex items-center gap-3 px-3 py-1.5 rounded-full">
      ...
      <span class="text-base min-w-[20px] text-center select-none">{{ props.item?.quantidade || 0 }}</span>
